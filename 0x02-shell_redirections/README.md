...
File 9-duplicate_last_line is a script that duplicates the last line of the file iactaFile 10-no_more_js is a script that deletes all the regular files (not the directories) with a .js extension that are present in the current directory and all its subfolders.
